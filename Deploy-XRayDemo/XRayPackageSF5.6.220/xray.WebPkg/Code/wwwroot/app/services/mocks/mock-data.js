System.register([], function (exports_1, context_1) {
    ...
    var ClusterCapacityList, ClusterFiltersData, ClusterInfoData, ClusterNodeList, ClusterNodeCapacityList, ApplicationList, ServiceList, ReplicaList;
    return {
        setters: [],
        execute: function () {
            exports_1("ClusterCapacityList", ClusterCapacityList = [
            ...
            exports_1("ClusterFiltersData", ClusterFiltersData = {
            ...
            exports_1("ClusterInfoData", ClusterInfoData = {
                'healthStatus': "Ok",
                'version': '5.0.135.94',
                'nodeTypes': ['FrontEnd', 'ProcessingNode', 'DataNode', 'StatisticsNode'],
                'applicationTypes': ['App1Type', 'App2Type'],
            ...
            exports_1("ClusterNodeList", ClusterNodeList = [
            ...
            exports_1("ClusterNodeCapacityList", ClusterNodeCapacityList = {
                'node1': [
            ...
            exports_1("ServiceList", ServiceList = {
                'fabric:/App1': [
                    {
            ...
            exports_1("ReplicaList", ReplicaList = {
