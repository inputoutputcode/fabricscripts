...
##    	New-SelfSignedCertificate -NotBefore '' -NotAfter '' -DnsName -CertStoreLocation Cert:\LocalMachine\My -Provider $provider -KeyExportPolicy ExportableEncrypted -Type Custom -Subject ""
